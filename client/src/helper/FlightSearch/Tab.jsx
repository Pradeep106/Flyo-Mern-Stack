...
const TabComponent = () => {
  ...
  return (
    <div className="w-full">
      <div className="flex  ">
        <button
          className={`px-4 py-2 border-b border-l border-t shadow-md  ${
        ...
        <button
          className={`px-4 py-2 border-t border-b shadow-md ${
        ...
        <button
          className={`px-4 py-2 border-b border-r border-t shadow-md  ${
